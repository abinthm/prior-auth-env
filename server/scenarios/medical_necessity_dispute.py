HARD_SCENARIO = {
    "goal": (
        ...
        "for patient Robert Okonkwo. Initial submission will be denied as 'not medically necessary.' "
        "You must: submit a formal appeal with supporting clinical documentation, "
        "then request and complete a peer-to-peer review with the payer's medical director. "
        "This requires identifying the correct clinical criteria and addressing each one."
    ),
    "patient": {
        "name": "Robert Okonkwo",
        "dob": "1961-11-05",
    ...
    "denial_sequence": [
        {
            ...
            "response": (
                ...
                "(3) Functional assessment documenting disability severity (ODI score), "
        ...
        },
        {
            ...
            "response": (
                ...
                "However, peer-to-peer review with our medical director is required "
                "before reconsideration. Please call 1-800-555-0271 ext. 4 to schedule. "
    ...
    "payer_criteria": (
        ...
        "Note: peer-to-peer review available upon request after formal appeal."
    ),
